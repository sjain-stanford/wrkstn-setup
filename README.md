...
17. In case of two GPUs, in order to dedicate one for X display and another for CUDA compute, follow the steps listed in [Doc-1](cuda/Two GPU config - CUDA Compute and X Display.pdf) and [Doc-2]((cuda/Two%20GPU%20config%20-%20StackOverflow.pdf)).
